	...
	<body>
		<div class="container-fluid">
			...
			<div class="row" class="target">
				...
				<?php
				$sql = "select * from tb_cidade where Cid_Codigo= '$_REQUEST[Codigo]'";
				$rs = mysql_query($sql,$conexao) or die ("Consulta nao realizada");
				$linha=mysql_fetch_array($rs);
					$codigo=$linha["Cid_Codigo"];
					$nome=$linha["Cid_Descricao"];
				?>
					<center>
						...
						<div class="form-group">
							<label class="col-md-4 control-label" for="nCid_Descricao">Cidade:</label>  
							<div class="col-md-4">
								<input id="nCid_Descricao" name="nCid_Descricao" type="text" value="<?php echo $nome; ?>" placeholder="" class="form-control input-md" required="">
