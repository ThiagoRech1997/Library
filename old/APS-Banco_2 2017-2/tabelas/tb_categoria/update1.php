	...
	<body>
		<div class="container-fluid">
			...
			<div class="row" class="target">
				...
				<?php
				$sql = "select * from tb_categoria where Cat_Codigo= '$_REQUEST[Codigo]'";
				$rs = mysql_query($sql,$conexao) or die ("Consulta nao realizada");
				$linha=mysql_fetch_array($rs);
					$codigo=$linha["Cat_Codigo"];
					$nome=$linha["Cat_Descricao"];
				?>
					<center>
						...
						<div class="form-group">
							<label class="col-md-4 control-label" for="nCat_Descricao">Categoria:</label>  
							<div class="col-md-4">
								<input id="nCat_Descricao" name="nCat_Descricao" type="text" value="<?php echo $nome; ?>" placeholder="" class="form-control input-md" required="">
							</div>
						</div>
