		...
		<div class="container-fluid">
			...
			<div class="row" class="target">
				<div id="footer" class="col-md-12">
					<center>
						<form class="form-horizontal" method = "post" action = "../tb_cliente/insert1.php">
						<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="nCli_Nome" name="nCli_Nome" type="text" placeholder="" class="form-control input-md" required="">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="nCli_Numero" name="nCli_Numero" type="number" placeholder="" class="form-control input-md">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="nCli_Fone" name="nCli_Fone" type="number" placeholder="" class="form-control input-md" required="">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="nCli_Prazodevol" name="nCli_Prazodevol" type="number" placeholder="" class="form-control input-md">
								<span class="help-block">Opcional</span>  
								</div>
						</div>
