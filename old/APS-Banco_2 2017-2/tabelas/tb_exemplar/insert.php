		...
		<div class="container-fluid">
			...
			<div class="row" class="target">
				<div id="footer" class="col-md-12">
					<center>
						<form class="form-horizontal" method = "post" action = "../tb_exemplar/insert1.php">
						<fieldset>

						<!-- Form Name -->
						<legend>Cadastrar Exemplar</legend>

						<!-- Select Basic -->
						<div class="form-group">
							<label class="col-md-4 control-label" for="rLiv_Titulo">Titulo:</label>
							<div class="col-md-4">
