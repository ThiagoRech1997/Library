	...
	<body>
		<div class="container-fluid">
			...
			<div class="row" class="target">
				...
				<?php
				$sql = "select * from tb_funcionario where Fun_Codigo= '$_REQUEST[Codigo]'";
				...
				$linha=mysql_fetch_array($rs);
					...
					$RG       = $linha["Fun_Rg"];
					$CPF      = $linha["Fun_Cpf"];
					$cargo    = $linha["Fun_Codcargo"];
					$endereco = $linha["Fun_Codendereco"];
					$bairro   = $linha["Fun_Codbairro"];
					$cidade   = $linha["Fun_Codcidade"];
				?>
					<center>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="nFun_Nome" name="nFun_Nome" type="text" value="<?php echo $nome; ?>" placeholder="" class="form-control input-md" required="">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="nCli_CPF" name="nCli_CPF" type="text" value="<?php echo $CPF; ?>" placeholder="" class="form-control input-md">
							...
							<div class="col-md-4">
								<select id="rCar_Descricao" name="rCar_Descricao" class="form-control">
									<option value="<?php echo $cargo;?>">
										<?php $sql = "Select Car_Descricao from tb_cargo where Car_Codigo = ".$cargo;
										$rt = mysql_query($sql, $conexao) or die (mysql_error());
										$t=mysql_fetch_array($rt); echo utf8_encode($t['Car_Descricao']);?></option>
									<?php 
