	...
	<body>
		<div class="container-fluid">
			...
			<div class="row" class="target">
				...
				<?php
				$sql = "select * from tb_editora where Edi_Codigo= '$_REQUEST[Codigo]'";
				$rs = mysql_query($sql,$conexao) or die ("Consulta nao realizada");
				$linha=mysql_fetch_array($rs);
					$codigo   = $linha["Edi_Codigo"];
					$nome     = $linha["Edi_Nome"];
					$endereco = $linha["Edi_Codendereco"];
					$bairro   = $linha["Edi_Codbairro"];
					$cidade   = $linha["Edi_Codcidade"];
					$fone     = $linha["Edi_Fone"];
				...
				?>
					<center>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="nEdi_Nome" name="nEdi_Nome" type="text" value="<?php echo $nome; ?>" placeholder="" class="form-control input-md" required="">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="nEdi_Fone" name="nEdi_Fone" type="text" value="<?php echo $fone; ?>" placeholder="" class="form-control input-md" required="">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="nEdi_Contato" name="nEdi_Contato" type="text" value="<?php echo $contato; ?>" placeholder="" class="form-control input-md">
