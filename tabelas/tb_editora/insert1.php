		...
		<div class="container-fluid">
			...
			<div class="row" class="target">
				<div id="footer" class="col-md-12">
					<center>
						<?php if (!$_POST['nEdi_Nome']||!$_POST['rEnd_Descricao']||!$_POST['rBai_Descricao']||!$_POST['rCid_Descricao']||!$_POST['nEdi_Fone']){ ?>
						...
						<?php
							...
							/** Inserção no Banco **/
							$SqlSit2 = "INSERT into tb_editora ";
							$SqlSit2 = $SqlSit2 . "(Edi_Codigo, Edi_Nome, Edi_Codendereco, Edi_Codbairro, Edi_Codcidade, Edi_Fone, Edi_Contato)";
							$SqlSit2 = $SqlSit2 . " values('null','$_POST[nEdi_Nome]','$_POST[rEnd_Descricao]','$_POST[rBai_Descricao]','$_POST[rCid_Descricao]','$_POST[nEdi_Fone]','$_POST[nEdi_Contato]');";
							$rsSit2 = mysql_query($SqlSit2, $conexao) or die (mysql_error());
							echo ("<span class='label label-success'>A Editora foi cadastrado com sucesso</span></h2>");
							echo ("<META HTTP-EQUIV='REFRESH' CONTENT='1; URL=../tb_editora/insert.php'>");   
						}
						mysql_close($conexao);
						?>
					</center>
