				...
				<div id="footer" class="col-md-12">
					<center>
						...
						<?php
							...
							$SqlSit2 = "UPDATE tb_categoria set
								Cat_Descricao = '$_POST[nCat_Descricao]'
								where Cat_Codigo = $_REQUEST[Codigo];";
							$rsSit2 = mysql_query($SqlSit2, $conexao) or die (mysql_error());
							echo ("<span class='label label-success'>A categoria foi atualizado com sucesso</span></h2>");
