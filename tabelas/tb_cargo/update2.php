				...
				<div id="footer" class="col-md-12">
					<center>
						...
						<?php
							...
							$SqlSit2 = "UPDATE tb_cargo set
								Car_Descricao = '$_POST[nCar_Descricao]',
								Car_Salariobase = '$_POST[nCar_SalarioBase]'
								where Car_Codigo = $_REQUEST[Codigo];";
							$rsSit2 = mysql_query($SqlSit2, $conexao) or die (mysql_error());
							echo ("<span class='label label-success'>O cargo foi atualizado com sucesso</span></h2>");
