	...
	<body>
		<div class="container-fluid">
			...
			<div class="row" class="target">
				...
				<?php
				$sql = "select * from tb_cargo where Car_Codigo= '$_REQUEST[Codigo]'";
				...
				?>
					<center>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="nCar_Descricao" name="nCar_Descricao" type="text" value="<?php echo $nome; ?>" placeholder="" class="form-control input-md" required="">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="nCar_SalarioBase" name="nCar_SalarioBase" type="number" value="<?php echo $salario; ?>" placeholder="" class="form-control input-md" required="">
