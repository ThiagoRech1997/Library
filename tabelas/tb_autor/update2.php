				...
				<div id="footer" class="col-md-12">
					<center>
						...
						<?php
							...
							$SqlSit2 = "UPDATE tb_autor set
								Aut_Nome = '$_POST[nAut_Nome]'
								where Aut_Codigo = $_REQUEST[Aut_Codigo];";
							$rsSit2 = mysql_query($SqlSit2, $conexao) or die (mysql_error());
							echo ("<span class='label label-success'>O autor foi atualizado com sucesso</span></h2>");
							echo ("<META HTTP-EQUIV='REFRESH' CONTENT='1; URL=../tb_autor/update.php'>");   
						}
						mysql_close($conexao);
						?>
					</center>
