	...
	<body>
		<div class="container-fluid">
			...
			<div class="row" class="target">
				...
				<?php
				$sql = "select * from tb_autor where Aut_Codigo= '$_REQUEST[Aut_Codigo]'";
				$rs = mysql_query($sql,$conexao) or die ("Consulta nao realizada");
				$linha=mysql_fetch_array($rs);
					$codigo=$linha["Aut_Codigo"];
					$nome=$linha["Aut_Nome"];
				?>
					<center>
						<form class="form-horizontal" method = "post" action = "../tb_autor/update2.php?Aut_Codigo=
									<?php echo $codigo;?>">
							<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
								<input id="nAut_Nome" name="nAut_Nome" type="text" value="<?php echo $nome; ?>" class="form-control input-md" required="">
