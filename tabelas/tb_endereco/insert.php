		...
		<div class="container-fluid">
			...
			<div class="row" class="target">
				<div id="footer" class="col-md-12">
					<center>
							<form class="form-horizontal" method = "post" action = "../tb_endereco/insert1.php">
							<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input id="nEnd_Descricao" name="nEnd_Descricao" type="text" placeholder="" class="form-control input-md" required="">
								</div>
							</div>
