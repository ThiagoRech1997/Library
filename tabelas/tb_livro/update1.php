	...
	<body>
		<div class="container-fluid">
			...
			<div class="row" class="target">
				...
				<?php
				$sql = "select * from tb_livro where Liv_Codigo= '$_REQUEST[Codigo]'";
				$rs = mysql_query($sql,$conexao) or die ("Consulta nao realizada");
				$linha=mysql_fetch_array($rs);
					$codigo    = $linha["Liv_Codigo"];
					$nome      = $linha["Liv_Titulo"];
					$editora   = $linha["Liv_Codeditora"];
					$categoria = $linha["Liv_Codcategoria"];
				...
				?>
					<center>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="nLiv_Titulo" name="nLiv_Titulo" type="text" value="<?php echo $nome; ?>" placeholder="" class="form-control input-md" required="">
							...
							<div class="col-md-4">
								<select id="rEdi_Nome" name="rEdi_Nome" class="form-control">
									<option value="<?php echo $editora;?>">
										<?php $sql = "Select Edi_Nome from tb_editora where Edi_Codigo = ".$editora;
										$rt = mysql_query($sql, $conexao) or die (mysql_error());
										$t=mysql_fetch_array($rt); echo utf8_encode($t['Edi_Nome']);?></option>
									<?php 
							...
							<div class="col-md-4">
								<select id="rCat_Descricao" name="rCat_Descricao" class="form-control">
									<option value="<?php echo $categoria;?>">
										<?php $sql = "Select Cat_Descricao from tb_categoria where Cat_Codigo = ".$categoria;
										$rt = mysql_query($sql, $conexao) or die (mysql_error());
										$t=mysql_fetch_array($rt); echo utf8_encode($t['Cat_Descricao']);?></option>
									<?php 
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="nLiv_Edicao" name="nLiv_Edicao" type="text" value="<?php echo $edicao; ?>" placeholder="" class="form-control input-md" required="">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="nLiv_Ano" name="nLiv_Ano" type="text" value="<?php echo $ano; ?>" placeholder="" class="form-control input-md" required="">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="nLiv_Prazominimo" name="nLiv_Prazominimo" type="text" value="<?php echo $minimo; ?>" placeholder="" class="form-control input-md">
