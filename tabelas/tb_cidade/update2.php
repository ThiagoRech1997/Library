				...
				<div id="footer" class="col-md-12">
					<center>
						...
						<?php
							...
							$SqlSit2 = "UPDATE tb_cidade set
								Cid_Descricao = '$_POST[nCid_Descricao]'
								where Cid_Codigo = $_REQUEST[Codigo];";
							$rsSit2 = mysql_query($SqlSit2, $conexao) or die (mysql_error());
							echo ("<span class='label label-success'>Cidade foi atualizado com sucesso</span></h2>");
