				...
				<div id="footer" class="col-md-12">
					<center>
						...
						<?php
							...
							$SqlSit2 = "UPDATE tb_bairro set
								Bai_Descricao = '$_POST[nBai_Descricao]'
								where Bai_Codigo = $_REQUEST[Codigo];";
							$rsSit2 = mysql_query($SqlSit2, $conexao) or die (mysql_error());
							echo ("<span class='label label-success'>O bairro foi atualizado com sucesso</span></h2>");
